        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="animate-fade-in">
              <p className="text-md max-w-2xl mx-auto text-secondary flex items-center justify-center lg:justify-start gap-2">
              ...
              {/* Line Divider */}
              <div className="border-b-2 border-secondary py-2"></div>
              ...
              <p className="text-lg md:text-xl lg:text-2xl mx-auto text-light flex items-center justify-center lg:justify-start gap-2">
                I'm Raffy Francisco
              </p>
              <p className="text-md max-w-2xl mx-auto lg:mx-0 text-secondary py-2">
            ...
            {/* Action Buttons */}
            <div className="flex gap-6 justify-center lg:justify-start flex-wrap animate-slide-up">
              <button
                className="font-semibold px-8 py-3 rounded-lg transition-all duration-300 flex items-center gap-2 group hover:opacity-80"
                style={{
              ...
              <button
                className="border-2 font-semibold px-8 py-3 rounded-lg transition-all duration-300 flex items-center gap-2 group hover:opacity-80"
                style={{
          ...
          <div className="flex justify-center items-center h-full">
            <div className="animate-slide-up w-full h-full">
              <div className="profile-image w-full h-full min-h-[400px] lg:min-h-[500px]">
